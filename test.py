...
# squareMapping2 = {(0, 1): 1, (0, 3): 2, (0, 5): 3, (0, 7): 4,
...
# print(squareMapping2[(0, 1)])

# backranktestarr = ['-', 'b', '-', 'B', '-', 'w', '-', 'w']

# backranktest = list(map(lambda x: True if x.lower() == 'b' else False, backranktestarr))

# print(backranktest, sum(backranktest))
# # print(unique, count)
# # print(dict(zip(unique, count))['b'])
...
#     # numMovesToKing = 8 - pieceRow if pieceColor == 'b' else pieceRow
#     moveList = []
...
#             moveList = runawayCheckers(tempBoard, (checkRow, checkCol))
...
# print(runawayBoard[5][4])
# print(runawayCheckers(runawayBoard, (5, 4)))
...
def initTable():
    # 8x8x12 array
    ZobristTable = [[[randomInt() for k in range(4)] for j in range(8)] for i in range(8)]

    for sublist in ZobristTable:
        print(id(sublist))
